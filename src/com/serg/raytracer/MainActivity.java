...
public class MainActivity extends Activity implements OnClickListener {
	...
	public void Render()
	{
        ...
        scene.objects.add(new Plane(new Vector(0, 0, 100), new Vector(0, -1, 0), Color.Yellow(), 0.0, 0, 1.1));//задн€€ стенка
        ...
        scene.objects.add(new Plane(new Vector(200, 0, 0), new Vector(-1, 0, 0), Color.Green(), 0.0, 0, 1.1));//лева€ стенка
        scene.objects.add(new Plane(new Vector(-200, 0, 0), new Vector(1, 0, 0), Color.Blue(), 0, 0, 1.1));//права€ стенка
